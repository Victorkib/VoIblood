...
function LoginForm() {
  ...
  return (
    <AuthCard
      title="Welcome Back"
      description="Sign in to access your blood bank dashboard"
      footerText="Don't have an account?"
      footerLink={<Link href="/auth/signup" className="font-semibold text-primary hover:underline">Sign up</Link>}
    >
