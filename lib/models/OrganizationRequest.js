...
const organizationRequestSchema = new mongoose.Schema(
  {
    ...
    requestedOrgDescription: {
      type: String,
      trim: true,
      default: '',
    },
    requestedOrgPhone: { type: String, trim: true, default: '' },
    requestedOrgAddress: { type: String, trim: true, default: '' },
    requestedOrgCity: { type: String, trim: true, default: '' },
    requestedOrgState: { type: String, trim: true, default: '' },
    requestedOrgCountry: { type: String, trim: true, default: 'Kenya' },
...
organizationRequestSchema.pre('save', async function () {
