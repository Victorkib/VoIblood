  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <FieldGroup>
          <Field>
            <FieldLabel>Invitation Token (Optional)</FieldLabel>
            <Input
              type="text"
              placeholder="Enter token if you were invited"
              name="inviteToken"
            ...
            <p className="text-xs text-foreground/50 mt-1">
              Have an invitation? Enter the token to join an organization directly.
            </p>
          </Field>
        </FieldGroup>
